...
assert_contains "upgrade preserves optional profile label" "PROFILE_LABEL=iran-upgrade-fixture" "${direct_root}/etc/gost/iran-1.env"
assert_contains "upgrade preserves allowed-source list" "ALLOWED_IRAN_SOURCES=198.51.100.10/32,198.51.100.11/32" "${direct_root}/etc/gost/kharej-2.env"
